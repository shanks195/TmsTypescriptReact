...
const SelectVersion: ForwardRefRenderFunction<SelectVersionRef, SelectVersionProps> = (props, ref) => {
  ...
  const options = Version.map(c => ({ value: c.id, label: c.version.toString() }));
...
export default forwardRef(SelectVersion);